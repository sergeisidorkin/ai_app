        ...
        "tables": {
            ...
            "contract_terms": {
                ...
                "columns": {
                    ...
                    "stage1_weeks": "Срок предв. отчёта, мес.",
                    "stage1_end": "Дата предв. отчёта",
                    "stage2_weeks": "Срок итог. отчёта, нед.",
                    "stage2_end": "Дата итог. отчёта",
            ...
            "contract_conclusion": {
                ...
                "columns": {
                    ...
                    "typical_section": "Типовой раздел",
                    "cloud": "Облако",
                    "docx_file": "Наименование файла DOCX",
                    "pdf_file": "Наименование файла PDF",
                },
            },
            "contract_dispatch": {
            ...
            "report_submission": {
                ...
                "columns": {
                    ...
                    "performer": "Исполнитель",
                    "asset_name": "Наименование актива",
                    "typical_section": "Раздел",
                    "status": "Статус",
                    "upload": "Загрузить",
                    "version": "Версия",
                    "send_date": "Дата статуса",
                    "check_result": "Результаты проверки",
                    "finding_count": "Число замечаний",
                },
            },
            "report_check": {
                "label": "Проверка",
                "columns": {
                    ...
                    "finding_count": "Число замечаний",
                    "check_value": "Проверка",
                    "model": "Модель",
                    "clear_comments": "Очистка",
                },
            },
            "report_macros": {
                "label": "Макросы",
