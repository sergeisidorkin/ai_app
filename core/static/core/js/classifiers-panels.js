(function () {
  ...
  document.addEventListener('click', async (e) => {
    ...
    const panel = btn.closest('#ber-actions, #bei-actions, #bat-actions, #bea-actions, #brl-actions, #oksm-actions, #okv-actions, #lei-actions, #katd-actions, #rfs-actions, #lw-actions, #ler-actions');
    if (!panel) return;
