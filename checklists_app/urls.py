...
urlpatterns = [
    ...
    path("customer-status/batch-update/", views.update_customer_status_batch, name="update_customer_status_batch"),
    path("status/touch-dates/", views.touch_status_dates, name="touch_status_dates"),
    ...
    path("shared/<str:token>/customer-status/batch-update/", views.shared_update_customer_status_batch, name="shared_update_customer_status_batch"),
