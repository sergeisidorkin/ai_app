...
NEXTCLOUD_INTERNAL_BASE_URL = env("NEXTCLOUD_INTERNAL_BASE_URL", default="")
...
NEXTCLOUD_CONNECT_TIMEOUT = env.float("NEXTCLOUD_CONNECT_TIMEOUT", default=3.0)
NEXTCLOUD_READ_TIMEOUT = env.float("NEXTCLOUD_READ_TIMEOUT", default=60.0)
NEXTCLOUD_OCS_READ_ATTEMPTS = env.int("NEXTCLOUD_OCS_READ_ATTEMPTS", default=2)
NEXTCLOUD_DAV_READ_ATTEMPTS = env.int("NEXTCLOUD_DAV_READ_ATTEMPTS", default=2)
NEXTCLOUD_MAX_CONCURRENT_REQUESTS_PER_PROCESS = env.int(
    "NEXTCLOUD_MAX_CONCURRENT_REQUESTS_PER_PROCESS",
    default=2,
)
NEXTCLOUD_SHARE_MAP_CACHE_TTL = env.float("NEXTCLOUD_SHARE_MAP_CACHE_TTL", default=15.0)
NEXTCLOUD_SHARE_MAP_ERROR_TTL = env.float("NEXTCLOUD_SHARE_MAP_ERROR_TTL", default=2.0)
NEXTCLOUD_LIVE_SHARE_LOOKUP_ON_READ = env.bool(
    "NEXTCLOUD_LIVE_SHARE_LOOKUP_ON_READ",
    default=True,
)
...
DSH_SORT_CHUNK_SIZE = env.int("DSH_SORT_CHUNK_SIZE", default=30)
DSH_SORT_FAST_FIRST_MAX_KITS = env.int("DSH_SORT_FAST_FIRST_MAX_KITS", default=200)
DSH_SORT_CHUNK_RETRIES = env.int("DSH_SORT_CHUNK_RETRIES", default=1)
DSH_SORT_MAX_DSH_CALLS = env.int("DSH_SORT_MAX_DSH_CALLS", default=500)
DSH_SORT_MAX_PROPOSAL_FILES = env.int("DSH_SORT_MAX_PROPOSAL_FILES", default=100)
DSH_SORT_MAX_REFINEMENT_DEPTH = env.int("DSH_SORT_MAX_REFINEMENT_DEPTH", default=4)
DSH_SORT_WORKER_LEASE_SECONDS = env.int("DSH_SORT_WORKER_LEASE_SECONDS", default=120)
DSH_SORT_WORKER_HEARTBEAT_SECONDS = env.int("DSH_SORT_WORKER_HEARTBEAT_SECONDS", default=30)
DSH_SORT_WORKER_VERIFY_BURST = env.int("DSH_SORT_WORKER_VERIFY_BURST", default=1)
...
REPORT_CHECK_LOCAL_ROOTS = tuple(
    root
    for root in env.list("REPORT_CHECK_LOCAL_ROOTS", default=[])
    if str(root).strip()
)
