...
urlpatterns = [
    ...
    path("projects/reports/table/", views.report_submission_table, name="report_submission_table"),
    ...
    path("projects/reports/<int:pk>/delete/", views.report_file_delete, name="report_file_delete"),
    ...
    path("projects/report-macros/", views.report_macros_table, name="report_macros_table"),
    ...
    path("projects/report-macros/csv-download/", views.report_macro_csv_download, name="report_macro_csv_download"),
    path("projects/report-macros/csv-upload/", views.report_macro_csv_upload, name="report_macro_csv_upload"),
