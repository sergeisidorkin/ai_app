(function () {
  function bindSelectableTables(root) {
    ...
    const masters = scope.querySelectorAll('#projects-pane thead input.form-check-input[data-target-name]');
    masters.forEach(master => {
      ...
      if (!master._selectableProjectsBound) {
        ...
        master._selectableProjectsBound = true;
      }
  ...
  document.body.addEventListener('htmx:afterSettle', (e) => {
    if (e.target && e.target.id === 'projects-pane') bindSelectableTables(e.target);
  });
})();