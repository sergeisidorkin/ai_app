...
class LetterTemplate(models.Model):
    ...
    TEMPLATE_VARIABLES = {
        "participation_confirmation": [
            ...
            ("{project_label}",
             "Обозначение проекта в формате «XXXXYZZ Тип Название проекта», где: "
            ...
            ("[project_stages]", "Этапы проекта и продукты"),
        ...
        "contract_sending": [
            ...
            ("{document_docx_link}",
             "Ссылка для скачивания DOCX (столбец «Наименование файла DOCX» таблицы «Составление проекта договора»)"),
            ("{document_pdf_link}",
             "Ссылка для скачивания PDF (столбец «Наименование файла PDF» таблицы «Составление проекта договора»)"),
            ("{duration_hours}", "Срок для принятия решения (часов)"),
            ("{deadline_at}", "Крайний срок ответа"),
        ],
        "proposal_sending": [
