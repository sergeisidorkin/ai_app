      ...
      '<span class="ql-formats letter-quill-toolbar__marker-group">' +
        '<span class="proposal-service-text-toolbar__list-split dropdown" data-list-marker-control>' +
          ...
          '<ul class="dropdown-menu proposal-service-text-toolbar__list-menu">' +
            ...
            '<li><button type="button" class="dropdown-item" data-letter-list="marker-option" data-list="circle" data-list-marker-option><span class="proposal-service-text-toolbar__marker-preview proposal-service-text-toolbar__marker-preview--circle">o</span>Круг</button></li>' +
            '<li><button type="button" class="dropdown-item" data-letter-list="marker-option" data-list="square" data-list-marker-option><span class="proposal-service-text-toolbar__marker-preview">▪</span>Квадрат</button></li>' +
            ...
            '<li><button type="button" class="dropdown-item" data-letter-list="marker-option" data-list="ndash" data-list-marker-option><span class="proposal-service-text-toolbar__marker-preview">–</span>Тире</button></li>' +
