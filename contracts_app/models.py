...
class ContractTemplate(models.Model):
    ...
    act_sample_name = models.CharField("Наименование образца акта", max_length=512, blank=True, default="")
    act_version = models.CharField("Версия акта", max_length=128, blank=True, default="")
    act_file = models.FileField("Файл акта", upload_to="contract_templates/", blank=True, default="")
