...
class ExpertContractDetailsForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "snils": forms.DateInput(attrs={"class": "form-control", "type": "date"}, format="%Y-%m-%d"),
